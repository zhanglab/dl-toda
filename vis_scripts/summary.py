...
def create_cm(args):
    ...
    with mp.Manager() as manager:
        ...
        with pd.ExcelWriter(f'{args.input}-cutoff-{args.cutoff}-confusion-matrix.xlsx') as writer:
...
def main():
    ...
    parser.add_argument('--cutoff', type=float, help='decision thershold above which reads are classified', default=0.0, require=('dl-toda' in sys.argv))
