...
if __name__ == "__main__":
	...
	incorrect_alignments = GetReadsAlignments(incorrect_sequences, f'{args.output_dir}/blast/test_reads_test_genome/all_test_pos_test_blastn.out', test_sequence_length, os.path.join(args.output_dir, f'blast/test_reads_test_genome/incorrect_{args.prob_threshold}_mapping_info.tsv'))
	correct_alignments = GetReadsAlignments(correct_sequences, f'{args.output_dir}/blast/test_reads_test_genome/all_test_pos_test_blastn.out', test_sequence_length, os.path.join(args.output_dir, f'blast/test_reads_test_genome/correct_{args.prob_threshold}_mapping_info.tsv'))
